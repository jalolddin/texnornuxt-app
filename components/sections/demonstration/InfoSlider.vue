<template>
  <div class="section-margin slider">
    <div class="slider__compensate">
      ...
      <div v-swiper:swiper="swiperOptions" @slideChange="slideChange" class="slider">
        <div class="swiper-wrapper">
          <template v-for="(slide, index) in slider">
            <label for="slide_img_check" v-if="!$route.path.includes(`/${$i18n.locale}/${slide.link}`)" :key="slide.index" class="swiper-slide slider__slide">
              <input :id="slide.title" :value="slide.model" v-model="checkedProducts" class="slide_img_check" type="checkbox">
...
export default {
  ...
  data () {
    return {
      activeSlide: 0,
      checked: false,
      checkedProducts: ['Проект RSD59'],
      slider: [
        {
          image: '/images/demonstration/ship_1.png',
          title: 'Антиас',
          model: 'Проект RSD59'
        },
        {
          image: '/images/demonstration/ship_2.png',
          title: 'Антиас',
          model: 'Проект RSD592'
        },
        {
